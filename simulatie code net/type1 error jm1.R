...
simulation_function_histo<-function(n,ncontrol,fixed_intercept,fixed_slope,residual_variance, cov_matrix, alpha, baseline, scale, followups, followupscontrol, nsim, correction=0){
...
set.seed(199)
sim_diff_size<-simulation_function_histo(200,150, b0_all, b1_all, var_e_all, covar_mat_all, alpha_all, intercept_all, scal_all, monthly_year,monthly_year, 100000)
set.seed(199)
sim_diff_duration<-simulation_function_histo(200,100, b0_all, b1_all, var_e_all, covar_mat_all, alpha_all, intercept_all, scal_all, monthly_year,monthly_oneandhalfyear, 100000)
set.seed(199)
sim_diff_interval<-simulation_function_histo(200,100, b0_all, b1_all, var_e_all, covar_mat_all, alpha_all, intercept_all, scal_all, threemonthly_year,monthly_year, 100000)
set.seed(199)
sim_diff_size_duration<-simulation_function_histo(200,150, b0_all, b1_all, var_e_all, covar_mat_all, alpha_all, intercept_all, scal_all, monthly_year,monthly_oneandhalfyear, 100000)
set.seed(199)
sim_diff_size_interval<-simulation_function_histo(200,150, b0_all, b1_all, var_e_all, covar_mat_all, alpha_all, intercept_all, scal_all, threemonthly_year,monthly_year, 100000)
set.seed(199)
sim_diff_duration_interval<-simulation_function_histo(200,100, b0_all, b1_all, var_e_all, covar_mat_all, alpha_all, intercept_all, scal_all, threemonthly_year,monthly_oneandhalfyear, 100000)
set.seed(199)
sim_diff_duration_interval_size<-simulation_function_histo(200,150, b0_all, b1_all, var_e_all, covar_mat_all, alpha_all, intercept_all, scal_all, threemonthly_year,monthly_oneandhalfyear, 100000)
set.seed(199)
sim_same_duration_interval_size<-simulation_function_histo(200,100, b0_all, b1_all, var_e_all, covar_mat_all, alpha_all, intercept_all, scal_all, threemonthly_year,threemonthly_year, 100000)
