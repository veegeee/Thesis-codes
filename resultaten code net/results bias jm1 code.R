...
p_lab1<-ggplot()+theme_void()+geom_text(aes(0,0,label='Covar'), family='tnr')
p_lab2<-ggplot()+theme_void()+geom_text(aes(0,0,label='Var B0'), family='tnr')
p_lab3<-ggplot()+theme_void()+geom_text(x=1, y=1,label= expression(sigma[b1]^2), family='tnr')
p_lab3<-ggplot()+theme_void()+annotate('text',x=1, y=1, label = expression(sigma[b1]^2), size=5)
p_lab4<-ggplot()+theme_void()+geom_text(aes(0,0,label= expression(beta[1])), family='tnr')
p_lab4<-ggplot()+theme_void()+annotate('text',x=1, y=1, label = expression(beta[1]), size=5)
p_lab5<-ggplot()+theme_void()+geom_text(aes(0,0,label= expression(beta[2])), family='tnr')
p_lab5<-ggplot()+theme_void()+annotate('text',x=1, y=1, label = expression(beta[2]), size = 5)

p_lab6<-ggplot()+theme_void()+geom_text(aes(0,0,label= expression(sigma[e]^2)), family='tnr')
p_lab6<-ggplot()+theme_void()+annotate('text',x=1, y=1, label = expression(sigma[e]^2), size =5)

p_lab7<-ggplot()+theme_void()+geom_text(aes(0,0,label='Slow'), family='tnr', size=5)
p_lab8<-ggplot()+theme_void()+geom_text(aes(0,0,label='Moderate'), family='tnr', size=5)
p_lab9<-ggplot()+theme_void()+geom_text(aes(0,0,label='Fast'), family='tnr', size=5)
p_lab10<-ggplot()+theme_void()+geom_text(aes(0,0,label='All'), family='tnr', size=5)
