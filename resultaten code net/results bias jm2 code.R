...
lijst<-list(sim_one_six_slow_slope, sim_three_six_slow_slope, sim_one_twelve_slow_slope, sim_three_twelve_slow_slope, 
            sim_one_eighteen_slow_slope, sim_three_eighteen_slow_slope, sim_one_six_interm_slope, sim_three_six_interm_slope,
            sim_one_twelve_interm_slope, sim_three_twelve_interm_slope, sim_one_eighteen_interm_slope, 
            sim_three_eighteen_interm_slope, sim_one_six_fast_slope, sim_three_six_fast_slope, sim_one_twelve_fast_slope,
            sim_three_twelve_fast_slope, sim_one_eighteen_fast_slope, sim_three_eighteen_fast_slope, sim_one_six_all_slope,
            sim_three_six_all_slope, sim_one_twelve_all_slope, sim_three_twelve_all_slope, sim_one_eighteen_all_slope,
            sim_three_eighteen_all_slope, 
            sim_one_six_slow_small_slope, sim_three_six_slow_small_slope, sim_one_twelve_slow_small_slope, 
            sim_three_twelve_slow_small_slope, sim_one_eighteen_slow_small_slope, sim_three_eighteen_slow_small_slope, sim_one_six_interm_small_slope, sim_three_six_interm_small_slope,
            sim_one_twelve_interm_small_slope, sim_three_twelve_interm_small_slope, sim_one_eighteen_interm_small_slope, 
            sim_three_eighteen_interm_small_slope, sim_one_six_fast_small_slope, sim_three_six_fast_small_slope, sim_one_twelve_fast_small_slope,
            sim_three_twelve_fast_small_slope, sim_one_eighteen_fast_small_slope, sim_three_eighteen_fast_small_slope, sim_one_six_all_small_slope,
            sim_three_six_all_small_slope, sim_one_twelve_all_small_slope, sim_three_twelve_all_small_slope, sim_one_eighteen_all_small_slope,
            sim_three_eighteen_all_small_slope)
...
p1<-ggplot(results_slow_cov, aes(Duration, Bias, color=Interval, linetype=Sample_size, group = group)) + geom_line() + geom_point() + labs(caption = 'Cov = 0.00', x='Duration')+theme(
...
p3<-ggplot(results_slow_varb1, aes(Duration, Bias, color=Interval, linetype=Sample_size, group = group)) + geom_line() + geom_point()+ labs(caption =expression(sigma[b1]^2==0.41), x='Duration')+theme(
  plot.caption = element_text(hjust = 0,size=9), axis.title.x = element_text(size=9), axis.title.y = element_text(size=9), legend.title =element_text(size=9), legend.text = element_text(size=8),legend.position = 'top' , text = element_text(family = 'tnr'))+ylim(-0.15,0)+ scale_linetype_discrete(name='Sample size')
#intermediate progressors
results_inter_cov<-results_inter[results_inter$var_comp=='cov',]
p4<-ggplot(results_inter_cov, aes(Duration, Bias, color=Interval, linetype=Sample_size, group = group)) + geom_line() + geom_point()+ labs(caption = 'Cov = -0.11', x='Duration')+theme(
  plot.caption = element_text(hjust = 0), axis.title.x = element_text(size=9), axis.title.y = element_text(size=9), legend.title =element_text(size=9), legend.text = element_text(size=8),legend.position = 'top' )
...
p7<-ggplot(results_fast_cov, aes(Duration, Bias, color=Interval, linetype=Sample_size, group = group)) + geom_line() + geom_point()+ labs(caption = 'Cov = -0.89', x='Duration')+theme(
  plot.caption = element_text(hjust = 0), axis.title.x = element_text(size=9), axis.title.y = element_text(size=9), legend.title =element_text(size=9), legend.text = element_text(size=8),legend.position = 'top' )
results_fast_varb0<-results_fast[results_fast$var_comp=='varb0',]
p8<-ggplot(results_fast_varb0, aes(Duration, Bias, color=Interval, linetype=Sample_size, group = group)) + geom_line() + geom_point()+ labs(caption = 'Var b0 = 31', x='Duration')+theme(
  plot.caption = element_text(hjust = 0), axis.title.x = element_text(size=9), axis.title.y = element_text(size=9), legend.title =element_text(size=9), legend.text = element_text(size=8),legend.position = 'top' )
results_fast_varb1<-results_fast[results_fast$var_comp=='varb1',]
p9<-ggplot(results_fast_varb1, aes(Duration, Bias, color=Interval, linetype=Sample_size, group = group)) + geom_line() + geom_point()+ labs(caption =expression(sigma[b1]^2==0.90), x='Duration')+theme(
  plot.caption = element_text(hjust = 0,size=9), axis.title.x = element_text(size=9), axis.title.y = element_text(size=9), legend.title =element_text(size=9), legend.text = element_text(size=8),legend.position = 'top' , text = element_text(family = 'tnr'))+ylim(-0.15,0)+ scale_linetype_discrete(name='Sample size')
#all progressors
results_all_cov<-results_all[results_all$var_comp=='cov',]
p10<-ggplot(results_all_cov, aes(Duration, Bias, color=Interval, linetype=Sample_size, group = group)) + geom_line() + geom_point()+ labs(caption = 'Cov = 0.73', x='Duration')+theme(
  plot.caption = element_text(hjust = 0), axis.title.x = element_text(size=9), axis.title.y = element_text(size=9), legend.title =element_text(size=9), legend.text = element_text(size=8),legend.position = 'top' )
...
p12<-ggplot(results_all_varb1, aes(Duration, Bias, color=Interval, linetype=Sample_size, group = group)) + geom_line() + geom_point()+ labs(caption =expression(sigma[b1]^2==0.62), x='Duration')+theme(
  plot.caption = element_text(hjust = 0,size = 9), axis.title.x = element_text(size=9), axis.title.y = element_text(size=9), legend.title =element_text(size=9), legend.text = element_text(size=8),legend.position = 'top' , text = element_text(family = 'tnr'))+ylim(-0.15,0)+ scale_linetype_discrete(name='Sample size')
#slow
...
p13<-ggplot(results_slow_b1, aes(Duration, Bias, color=Interval, linetype=Sample_size, group = group)) + geom_line() + geom_point()+ labs(caption =expression(beta[1]==-0.74), x='Duration')+theme(
  plot.caption = element_text(hjust = 0,size = 9), axis.title.x = element_text(size=9), axis.title.y = element_text(size=9), legend.title =element_text(size=9), legend.text = element_text(size=8),legend.position = 'top' , text = element_text(family = 'tnr'))+ylim(0.002,0.16)+ scale_linetype_discrete(name='Sample size')
results_slow_res<-results_slow[results_slow$var_comp=='resvar',]
p14<-ggplot(results_slow_res, aes(Duration, Bias, color=Interval, linetype=Sample_size, group = group)) + geom_line() + geom_point()+ labs(caption =expression(sigma[e]^2==3.0), x='Duration')+theme(
  plot.caption = element_text(hjust = 0,size = 9), axis.title.x = element_text(size=9), axis.title.y = element_text(size=9), legend.title =element_text(size=9), legend.text = element_text(size=8),legend.position = 'top' , text = element_text(family = 'tnr'))+ylim(-0.007, 0.11)+ scale_linetype_discrete(name='Sample size')
...
p15<-ggplot(results_slow_b2, aes(Duration, Bias, color=Interval, linetype=Sample_size, group = group)) + geom_line() + geom_point()+ labs(caption =expression(beta[2]==0.22), x='Duration')+theme(
  plot.caption = element_text(hjust = 0,size = 9), axis.title.x = element_text(size=9), axis.title.y = element_text(size=9), legend.title =element_text(size=9), legend.text = element_text(size=8),legend.position = 'top' , text = element_text(family = 'tnr'))+ylim(-0.055,0.002)+ scale_linetype_discrete(name='Sample size')
...
p19<-ggplot(results_fast_b1, aes(Duration, Bias, color=Interval, linetype=Sample_size, group = group)) + geom_line() + geom_point()+ labs(caption =expression(beta[1]==-1.6), x='Duration')+theme(
  plot.caption = element_text(hjust = 0,size = 9), axis.title.x = element_text(size=9), axis.title.y = element_text(size=9), legend.title =element_text(size=9), legend.text = element_text(size=8),legend.position = 'top' , text = element_text(family = 'tnr'))+ylim(0.002,0.16)+ scale_linetype_discrete(name='Sample size')
...
p21<-ggplot(results_fast_b2, aes(Duration, Bias, color=Interval, linetype=Sample_size, group = group)) + geom_line() + geom_point()+ labs(caption =expression(beta[2]==0.48), x='Duration')+theme(
  plot.caption = element_text(hjust = 0,size = 9), axis.title.x = element_text(size=9), axis.title.y = element_text(size=9), legend.title =element_text(size=9), legend.text = element_text(size=8),legend.position = 'top' , text = element_text(family = 'tnr'))+ylim(-0.055,0.002)+ scale_linetype_discrete(name='Sample size')
...
p24<-ggplot(results_all_b2, aes(Duration, Bias, color=Interval, linetype=Sample_size, group = group)) + geom_line() + geom_point()+ labs(caption =expression(beta[2]==0.30), x='Duration')+theme(
  plot.caption = element_text(hjust = 0,size = 9), axis.title.x = element_text(size=9), axis.title.y = element_text(size=9), legend.title =element_text(size=9), legend.text = element_text(size=8),legend.position = 'top' , text = element_text(family = 'tnr'))+ylim(-0.055,0.002)+ scale_linetype_discrete(name='Sample size')


p_lab0<-ggplot()+theme_void()
p_lab1<-ggplot()+theme_void()+geom_text(aes(0,0,label='Covar'))
p_lab2<-ggplot()+theme_void()+geom_text(aes(0,0,label='Var B0'))
p_lab3<-ggplot()+theme_void()+geom_text(aes(0,0,label='Var B1'))
p_lab3<-ggplot()+theme_void()+annotate('text',x=1, y=1, label = expression(sigma[b1]^2),size=5)

p_lab4<-ggplot()+theme_void()+geom_text(aes(0,0,label='B1'))
p_lab4<-ggplot()+theme_void()+annotate('text',x=1, y=1, label = expression(beta[1]),size=5)

p_lab5<-ggplot()+theme_void()+geom_text(aes(0,0,label='B2'))
p_lab5<-ggplot()+theme_void()+annotate('text',x=1, y=1, label = expression(beta[2]),size=5)

p_lab6<-ggplot()+theme_void()+geom_text(aes(0,0,label='Res var'))
p_lab6<-ggplot()+theme_void()+annotate('text',x=1, y=1, label = expression(sigma[e]^2),size=5)

p_lab7<-ggplot()+theme_void()+geom_text(aes(0,0,label='Slow'))
p_lab8<-ggplot()+theme_void()+geom_text(aes(0,0,label='Moderate'))
p_lab9<-ggplot()+theme_void()+geom_text(aes(0,0,label='Fast'))
p_lab10<-ggplot()+theme_void()+geom_text(aes(0,0,label='All'))
